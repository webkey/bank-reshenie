$(document).ready(function () {
	$('.menu2 li.top, .menu1').hover(function (e) {
		if (e.pageX) {
			menu_slider.stop();
		}
	...
	$('.menu2 ul, .top_menu').hover(function () {
	...
	$(".action a").click(function () {
		...
		if (_actionCont.is(':visible')) {
			...
			_actionCont.load($(this).attr("href") + '?ajax=1', function () {
				_actionCont.slideDown();
			});
		}
		return false;
	});
...
var menu_slider = {
	...
	stopSlide: false, speedNext: 5000,
